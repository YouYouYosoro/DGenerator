    ...
    if "moonshot-v1-8k" in model:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user",
                 "content": f"{str}, 另外我今天想吃的食物是：{food}，给我列出该食物的每100克营养成分，并根据我的个人信息与想吃的食物给出科学合理的菜品信息与烹饪方法，另外根据我的健康目标给出合理科学的饮食建议" +
                            f"请在给出建议之后立即停止回答"}
            ])
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": f"你是一个优秀的专业的营养师与厨师,你擅长根据客户的信息给出合理科学的饮食方案"},
                {"role": "user",
                 "content": f"{str}, 另外我今天想吃的食物是：{food}，给我列出该食物的每100克营养成分，并根据我的个人信息与想吃的食物给出科学合理的菜品信息与烹饪方法，" +
                            f"另外根据我的健康目标给出合理科学的饮食建议" +
                            f"请在给出建议之后立即停止回答"}
            ])
        ...
        response = Application.call(app_id=f'{qwen_app_id}',
                                    prompt=f"{str}, 另外我今天想吃的食物是：{food}，给我列出该食物的每100克营养成分，" +
                                           f"并根据我的个人信息与想吃的食物给出科学合理的菜品信息与烹饪方法，另外根据我的健康目标给出合理科学的饮食建议" +
                                           f"请在给出建议之后立即停止回答",
                                    api_key=f'{qwen_key}',
                                    )
        ...
        messages = [ChatMessage(
            role="user",
            content=f"{str}, 今天想吃的食物是：{food}，给我列出该食物的每100克营养成分，" +
                                           f"并根据我的个人信息与想吃的食物给出科学合理的菜品信息与烹饪方法，另外根据我的健康目标给出合理科学的饮食建议" +
                                           f"请在给出建议之后立即停止回答"
        )]
